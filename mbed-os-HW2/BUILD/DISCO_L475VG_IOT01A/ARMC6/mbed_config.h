...
#define MBED_CONF_APP_HOSTNAME                                                  "192.168.1.2"                                                                                    // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                   "089349851"                                                                                      // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                   WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                       "chtwifi"                                                                                        // set by application[*]
